...
//     id UUID PRIMARY KEY DEFAULT fhir_generate_id(),
//     entity_id UUID NOT NULL REFERENCES "fhir"."entity" ("id") ON DELETE CASCADE,
// );
//
// CREATE INDEX "fhir"."entity_index_text_entity_id_idx" ON "fhir"."entity_index_text" ("entity_id");
//     "#,
//     name = "entity_index_text",
//     requires = [fhir_generate_id]
// );
